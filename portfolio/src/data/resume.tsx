...
export const DATA = {
    ...
    locationLink:
        "https://www.google.com/maps/place/Delhi/@28.6440837,77.0932314,10z/data=!3m1!4b1!4m6!3m5!1s0x390cfd5b347eb62d:0x37205b715389640!8m2!3d28.7040592!4d77.1024902!16zL20vMDlmMDc?entry=ttu&g_ep=EgoyMDI1MTAyOC4wIKXMDSoASAFQAw%3D%3D",
    description:
    ...
    work: [
        ...
        },
        {
            ...
            description:
                "Selected as research intern under Dr. Shiv Ram Meena at USICT, GGSIPU. Pursuing research on practical AI and ML applications",
        },
        {
    ...
    projects: [
        {
            title: "TalentLoop",
            href: "https://github.com/TechTerrorists/TalentLoop",
            dates: "Oct 2025 - Nov 2025",
            active: true,
            description:
                "TalentLoop is an AI-powered interview platform that conducts realistic, voice-based conversations with candidates using digital recruiters. Built with Pipecat and Tavus, it delivers adaptive, context-aware interviews through RAG and a modern Next.js interface.",
            technologies: [
                "Next.js",
                "Typescript",
                "Python",
            ...
            image: "/talentloopscreen.png",
            video: "",
        },
        {
            title: "JobNexus",
            href: "https://github.com/TechTerrorists/JobNexus",
            dates: "Dec 2025 - Jan 2026",
            active: true,
            description:
                "JobNexus is an autonomous AI agent that streamlines the entire job hunt—from discovery to interview prep. It uses Gemini-powered LLMs to analyze resumes and semantically match them with high-intent job listings. Beyond just finding jobs, it automates hyper-personalized cold outreach campaigns and features a real-time, voice-based AI interview coach (built with LiveKit) to simulate technical rounds.",
            technologies: [
                "Next.js",
                "Typescript",
                "Python",
